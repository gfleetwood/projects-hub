...
The main code can be found in `app_non_technical.R`. `app_technical.R` is its precursor geared towards more
technical users, but not solving a problem that any decent SQL client hasn't solved already.
